        ...
        Wrap(
          ...
          children: [
            ...
            _ShapeButton(
              ...
              label: 'Elips',
              isSelected: selectedShape == ShapeType.ellipse,
            ...
            _ShapeButton(
              ...
              label: 'Yıldız',
              isSelected: selectedShape == ShapeType.star,
              onTap: () => onShapeSelected(ShapeType.star),
              selectedColor: scheme.primary,
            ),
            _ShapeButton(
              ...
              label: 'Beşgen',
              isSelected: selectedShape == ShapeType.pentagon,
              onTap: () => onShapeSelected(ShapeType.pentagon),
              selectedColor: scheme.primary,
            ),
            _ShapeButton(
              ...
              label: 'Altıgen',
              isSelected: selectedShape == ShapeType.hexagon,
              onTap: () => onShapeSelected(ShapeType.hexagon),
              selectedColor: scheme.primary,
            ),
            _ShapeButton(
            ...
            _ShapeButton(
              ...
              label: 'Çift Ok',
              isSelected: selectedShape == ShapeType.doubleArrow,
              onTap: () => onShapeSelected(ShapeType.doubleArrow),
              selectedColor: scheme.primary,
            ),
          ],
        ),
