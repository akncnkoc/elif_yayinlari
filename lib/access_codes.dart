...
class ResourceConfig {
  ...
  factory ResourceConfig.fromJson(Map<String, dynamic> json) {
    ...
    return ResourceConfig(
      ...
      type: (typeStr == 'file') ? ResourceType.file : ResourceType.folder,
    );
  }
}
...
class AccessCodeService {
  ...
  static const String _baseUrl = 'http://192.168.100.40:8000';
  ...
  static Future<List<ResourceConfig>> verifyCode(String code) async {
    ...
    try {
        ...
        if (data['success'] == true) {
          ...
          if (responseData.containsKey('resources')) {
            ...
            return resourcesJson
                .map((json) => ResourceConfig.fromJson(json))
                .toList();
          } else {
      ...
      // If not in local fallback, rethrow to allow UI to handle connection error
      rethrow;
    }
  }
}
