...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    super.initState();
    // Desktop platformlarda sanal klavye dinleyicilerini ekle
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          controller: _usernameController,
                          focusNode: _usernameFocus,
                          // Desktop'ta sistem klavyesini kapat, sanal klavyeyi kullan
                          readOnly: !Platform.isAndroid && !Platform.isIOS,
                          showCursor: !Platform.isAndroid && !Platform.isIOS,
